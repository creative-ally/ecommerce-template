...
const SingleInterior = () => {
    ...
    useEffect(() => {
        const getProduct = async () => {
            try {
                const response = await axios.get(`http://localhost:5000/singleinteriorproduct/${id}`)
                    ...
                    <div class="container px-5 mx-auto">
                        <div class="lg:w-4/5 mx-auto flex flex-wrap items-center">
                            <div class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                                ...
                                <h1 class="text-gray-900 text-3xl title-font font-medium mt-2 mb-3">{singleproduct.name}</h1>

                                <div class="flex border-t border-gray-200 py-2">
                                    <span class="text-gray-500">Color</span>
                                    <span class="ml-auto text-gray-900">{singleproduct.color}</span>
                                </div>
                                <div class="flex border-t border-gray-200 py-2">
                                    <span class="text-gray-500">Material</span>
                                    <span class="ml-auto text-gray-900">{singleproduct.material}</span>
                                </div>
