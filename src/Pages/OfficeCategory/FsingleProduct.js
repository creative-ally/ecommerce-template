                ...
                <div className="container px-5 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap items-center">
                        <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                            ...
                            <h1 className="text-gray-900 text-3xl title-font font-medium mt-2 mb-3">{product.name}</h1>
                            ...
                            <div className="flex border-t border-gray-200 py-2">
                                ...
                                <span className="ml-auto text-gray-900">{product.material}</span>
                            </div>
                        ...
                        <div className='mt-[-40px] mb-8'>
                            <h2 className="text-3xl title-font text-gray-500 tracking-widest border-b mb-4 py-3 border-gray-200">Description</h2>
